...
(function (AccountType) {
    AccountType[AccountType["FREE_LIMITED"] = 0] = "FREE_LIMITED";
    AccountType[AccountType["FREE"] = 1] = "FREE";
    AccountType[AccountType["PEOPLE"] = 2] = "PEOPLE";
})(AccountType || (AccountType = {}));
var DialogType;
(function (DialogType) {
    DialogType[DialogType["UNRECOVERABLE"] = 0] = "UNRECOVERABLE";
    DialogType[DialogType["ALERT"] = 1] = "ALERT";
    DialogType[DialogType["CONFIRM"] = 2] = "CONFIRM";
    DialogType[DialogType["PROMPT"] = 3] = "PROMPT";
...
function checkAccountNum(value) {
    if (/[^0-9-\s]+/.test(value))
        return false;
...
function createDialog(title, content, type, id = "") {
    ...
    var buttons = [];
    const show = () => {
        container === null || container === void 0 ? void 0 : container.append(dialogBackground);
        dialogBackground === null || dialogBackground === void 0 ? void 0 : dialogBackground.classList.remove("hidden");
    };
    const destroy = () => {
        container === null || container === void 0 ? void 0 : container.removeChild(dialogBackground);
        dialogBackground === null || dialogBackground === void 0 ? void 0 : dialogBackground.classList.add("hidden");
    };
    const register = (event, callback) => {
        var _a;
        (_a = buttonContainer.querySelector(`button[data-buttonAction=${event}]`)) === null || _a === void 0 ? void 0 : _a.addEventListener("click", callback);
    };
...
function checkServer(dt, number_of_date, name) {
    const UTC_PLUS9_OFFSET = 32400;
...
function verifyAccount(account) {
    ...
    if (Math.sqrt(ij) % 1 != 0)
        return false;
    if (total_klmn % o_check != o)
        return false;
    if (bcdef % abc != pqr)
        return false;
    if (jklm % s_check != s)
        return false;
    if (!checkAccountNum(acc))
        return false;
    return true;
}
...
switch (document.body.getAttribute("data-type")) {
    ...
    case "pricing":
        ...
        function getFreeLimitedAccount() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                confirm_prompt.show();
                confirm_prompt.register("yes", () => __awaiter(this, void 0, void 0, function* () {
                    yield serverContact();
    ...
    case "server":
        ...
        const data_fetch = () => __awaiter(this, void 0, void 0, function* () {
            var dt = new Date();
            ...
            const d = yield fetch(SERVER_INFO_ADDRESS).then(e => e.json());
            const e = d.map(v => {
    ...
    case "apps":
        ...
        qSel("#app_login_button").addEventListener("click", () => {
            ...
            prompt.show();
            prompt.element.querySelector("input").value = (_a = localStorage.getItem("k")) !== null && _a !== void 0 ? _a : "";
            prompt.register("ok", () => {
        ...
        qSel("#selected_vpn_server").addEventListener("change", () => __awaiter(this, void 0, void 0, function* () {
            var prev = "";
            var dialog = createDialog("Changing server", "Now changing the VPN server...", DialogType.UNRECOVERABLE);
            dialog.show();
            prev = iframe.src;
            iframe.src = "about:blank";
            yield wait(getRandom(3500, 7000));
            dialog.destroy();
            iframe.src = prev;
        }));
        qSel("#app_go").addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            const url = qSel("#url_bar").value;
            if (URL_CHECK_REGEX.test(url)) {
                ...
                dialog.show();
                iframe.src = "about:blank";
                yield wait(getRandom(5000, 12000));
                dialog.destroy();
        ...
        const server_data = () => __awaiter(this, void 0, void 0, function* () {
            var dt = new Date();
            const number_of_date = (dt.getUTCFullYear() - 1970) * 365 + (dt.getUTCMonth() + 1) * 31 + dt.getUTCDate();
            const d = yield fetch(SERVER_INFO_ADDRESS).then(e => e.json());
            var e = d.map(v => {
            ...
            const elm = qSel("#selected_vpn_server");
    ...
    case "block":
        var blocked_website = "";
        const url_display = qSel("#url_display");
        onmessage = (e) => {
